#define usage "\n\n\n\
NAME\n\
	otftopsf --- compute PSF from makeotf output\n\
SYNOPSIS\n\
	otftopsf dtheta thetamax [-l lambda]\n\
\n\
DESCRIPTION\n\
	'otftopsf' reads a file containing z gk(z) from stdin and\n\
	computes\n\
\n\
...
int		main(int argc, char *argv[])	
{
	...
	if (!ipf) {
		error_exit("otftopsf: failed to open input pipe\n");
	}
