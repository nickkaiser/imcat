/* linear equation solves from numerical recipes */
/* modified to double precision */
/* modified to ANSI style declarations */
/* added conversions to zero offset vectors */
